  ...
  return (
    ...
    <div className="w-screen md:w-full">
      <div className="flex flex-wrap gap-5 p-2 md:!px-8">
        ...
        />
        <SelectMonth start={-3} indexDefaultValue={3} value={date? date : ""} onChange={(e) => setDate(e.target.value)} showArrows />
      </div>
                  ...
                  {activities.map((e, i) => {
                    return (
                      <React.Fragment key={e.projectName}>
                        <tr className="border-t border-b border-r border-[#E5EAEF]" key={`1-${e._id}`} onClick={() => setOpen(open === i ? null : i)}>
